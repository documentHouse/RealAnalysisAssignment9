...
%Because $x = \frac{p}{q}$ we can take each element in the sum $\frac{p}{n} + \frac{x}{n} + \frac{x}{n^2}$ to be positive since we are taking the absolute value. We note that then we have $\frac{p}{n} + \frac{x}{n} + \frac{x}{n^2} > \frac{p}{n}$. This gives
%\begin{equation}
%|f_n(x)g_n(x) - f(x)g(x)| > \frac{p}{n} \quad \text{for x $\in \mathbb{Q}$ and $x = \frac{p}{q}$}
%\end{equation}
